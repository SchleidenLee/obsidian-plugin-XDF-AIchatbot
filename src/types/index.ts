...
export interface LlmHubSettings {
  ...
  /** Auto-detect the sibling xdf-toolkits HTTP MCP plugin. */
  xdfAutoBindToolkits: boolean;
...
export const DEFAULT_WORKSPACE_FOLDER = "XDF-AI";
  ...
  apiProviders: [
    {
      ...
      name: "XDF NewAPI",
      type: "custom",
      baseUrl: "https://api.schleiden.space/v1",
      apiKey: "",
